...
std::pair<std::vector<double>, std::vector<double>> ODESolve (SolveMethod method, const Task &task, const Matrix<double> butcher, double h, IterationAlgo iter_alg, double approx) {
    switch (method) {
